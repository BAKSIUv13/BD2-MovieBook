...
CREATE TABLE IF NOT EXISTS `MovieBookDataBase`.`Show` (
  ...
  INDEX `fk_Show_Movie1_idx` (`Movie_idMovie` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `MovieBookDataBase`.`Question` (
  ...
  `rightAnswer_idAnswer` INT(11) NOT NULL,
  PRIMARY KEY (`idQuestion`),
  INDEX `fk_Question_1_idx` (`rightAnswer_idAnswer` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `MovieBookDataBase`.`Movie_has_Artist` (
  `Movie_idMovie` INT(11) NOT NULL,
  `Artist_has_ArtistType_id` INT(11) NOT NULL,
  `Role` VARCHAR(45) NULL DEFAULT NULL,
  INDEX `fk_Movie_has_Artist_Movie1_idx` (`Movie_idMovie` ASC) VISIBLE,
  INDEX `fk_Movie_has_Artist_1_Artist1_idx` (`Artist_has_ArtistType_id` ASC) VISIBLE,

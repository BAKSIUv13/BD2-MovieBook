...
INSERT INTO `Artist`(`idArtist`, `name`, `surname`, `origin`, `birthDate`) VALUES (1,'James','Cameron','Canada','1971-09-16');
INSERT INTO `Artist`(`idArtist`, `name`, `surname`, `origin`, `birthDate`) VALUES (2,'Leonardo','DiCaprio','USA','1974-11-11');
INSERT INTO `Artist`(`idArtist`, `name`, `surname`, `origin`, `birthDate`) VALUES (3,'Kate','Winslet','United Kingdom','1975-10-05');
INSERT INTO `Artist`(`idArtist`, `name`, `surname`, `origin`, `birthDate`) VALUES (4,'James','Horner','USA','1953-09-14');
